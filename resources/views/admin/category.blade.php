...
<div class="card shadow mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary"><a href="{{action('IndexController@create_category_page')}}" class="btn btn-sm btn-primary">Create</a></h6>
            </div>
            <div class="card-body">
